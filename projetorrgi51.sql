...
--
-- Host: 127.0.0.1
-- Tempo de geração: 10/04/2026 às 16:52
...
(2, 2, 'Frango a milanesa', 'Arroz, Frango empanado, Feijão Preto, Farofa, Salada, Macarrão, Batata Frita', 1);
...
(1, 'Admin Restaurante', 'admin@restaurante.com', '$2y$10$COLE_AQUI_O_HASH_DO_123456', 'admin', 1),
(2, 'Chefe', 'chefe@comida.com', '2y$10$COLE_AQUI_O_HASH_DO_123456', 'vendedor', 1);
